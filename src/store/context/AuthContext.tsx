...
import { destroyCookie, setCookie } from '@/utils/cookie'
import { AuthUserProps, ContextProps } from '@/interfaces/context'
import { AUTH_TOKEN } from '@/constants/localStorageConstants'
import { SESSION_TOKEN } from '@/constants/cookieConstants'
import { decodeUser } from '@/utils/parsers'
import { useQuery } from '@apollo/client'
import { GQLResult } from '@/interfaces/general'
import { QUERY_FIND_USER_BY_ID } from '@/Graphql/Query/users'
